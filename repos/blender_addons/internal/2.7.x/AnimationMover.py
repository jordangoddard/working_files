                        ...
                        try:
                            ...
                            if anim:
                                ...
                                try:
                                    ...
                                    fc[2].lock = True
                                    fc[3].lock = False
                                    fc[3].data_path = 'pose.bones["%s"].rotation_euler'%target_bone
                                    fc[3].array_index = 0
                                    fc[3].lock = True
                                    fc[4].lock = False
                                    fc[4].data_path = 'pose.bones["%s"].rotation_euler'%target_bone
                                    fc[4].array_index = 1
                                    fc[4].lock = True
                                    fc[5].lock = False
                                    fc[5].data_path = 'pose.bones["%s"].rotation_euler'%target_bone
                                    fc[5].array_index = 2
                                    fc[5].lock = True
                                    fc[6].lock = False
                                    fc[6].data_path = 'pose.bones["%s"].scale'%target_bone
                                    fc[6].array_index = 0
                                    fc[6].lock = True
                                    fc[7].lock = False
                                    fc[7].data_path = 'pose.bones["%s"].scale'%target_bone
                                    fc[7].array_index = 1
                                    fc[7].lock = True
                                    fc[8].lock = False
                                    fc[8].data_path = 'pose.bones["%s"].scale'%target_bone
                                    fc[8].array_index = 2
                                    fc[8].lock = True
                            else:
                                print("There are no actions on this bone to push to the new character")
